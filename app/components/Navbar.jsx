...
const Navbar = () => {
  ...
  // Side effect to navigate if user is not authenticated
  useEffect(() => {
    if (!user && !userSession) {
      router.push('/sign-up');
    }
  ...
  return (
    <div>
      <nav className="bg-blue-500 lg:p-1">
          ...
          <div className="relative flex h-16 items-center justify-between">
            <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
              ...
              <button
                ...
                onClick={toggleMobileMenu} // Toggle mobile menu visibility on click
              >
            ...
            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
              <div className="flex shrink-0 items-center">
                <img
                  ...
                  src="https://img.freepik.com/free-psd/pinterest-logo-3d-social-media-icon-isolated_47987-11968.jpg?semt=ais_hybrid"
                  alt="Your Company"
                />
              </div>
              ...
              <div className="relative ml-3">
                <div>
                  <button
                    ...
                    onClick={toggleMenu} // Toggle user menu visibility on click
